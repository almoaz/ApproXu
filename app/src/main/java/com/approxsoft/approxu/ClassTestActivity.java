...
public class ClassTestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mToolabr = new Toolbar(this);
        mToolabr = findViewById(R.id.class_test_ap_bar);
        ...
        spinner = findViewById(R.id.class_test_spinner);
        topicsText = findViewById(R.id.class_test_topics);
        timeText = findViewById(R.id.class_test_date);
        uploadBtn = findViewById(R.id.class_test_upload_btn);
        listViewData = findViewById(R.id.cr_upload_list_view);
        universityName = findViewById(R.id.class_test_university);
        departmentsname = findViewById(R.id.class_test_departments);
        semesterName = findViewById(R.id.class_test_semester);
        groupName = findViewById(R.id.class_test_group);


        spinnerDataList = new ArrayList<>();
        adapter = new ArrayAdapter<String>(ClassTestActivity.this,
                            ...
                            if (dataSnapshot.exists())
                            {
                                ...
                                mRef.addValueEventListener(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                        ...
                                        DataList adapter = new DataList(ClassTestActivity.this, dataList);
    ...
    public void deleteData(String subjectId) {
        DatabaseReference dataRef = FirebaseDatabase.getInstance().getReference().child("All University").child(universityName.getText().toString()).child(departmentsname.getText().toString()).child(semesterName.getText().toString()).child(groupName.getText().toString()).child("Class Test").child(subjectId);
        dataRef.removeValue();
    ...
    private boolean updateData(String id, String subject, String topics, String date) {
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference().child("All University").child(universityName.getText().toString()).child(departmentsname.getText().toString()).child(semesterName.getText().toString()).child(groupName.getText().toString()).child("Class Test").child(id);
    ...
    public void uploadStored() {
        ...
        if (!TextUtils.isEmpty(name)) {
            ...
            String id = SubjectReff.child("Class Test").push().getKey();
            Data data = new Data(id, name, topics, time);
            SubjectReff.child("Class Test").child(id).setValue(data);
