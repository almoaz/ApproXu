...
public class ClassNoticeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mToolBar = findViewById(R.id.class_notice_ap_bar);
        ...
        spinner = findViewById(R.id.class_notice_spinner);
        topicsText = findViewById(R.id.class_notice_topics);
        timeText = findViewById(R.id.class_notice_date);
        uploadBtn = findViewById(R.id.class_notice_upload_btn);
        listViewData = findViewById(R.id.cr_notice_list_view);
        universityName = findViewById(R.id.class_notice_university);
        departmentsname = findViewById(R.id.class_notice_departments);
        semesterName = findViewById(R.id.class_notice_semester);
        groupName = findViewById(R.id.class_notice_group);


        spinnerDataList = new ArrayList<>();
        adapter = new ArrayAdapter<String>(ClassNoticeActivity.this,
                            ...
                            if (dataSnapshot.exists())
                            {
                                ...
                                mRef.addValueEventListener(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                        ...
                                        DataList adapter = new DataList(ClassNoticeActivity.this, dataList);
    ...
    public void deleteData(String subjectId) {
        DatabaseReference dataRef = FirebaseDatabase.getInstance().getReference().child("All University").child(universityName.getText().toString()).child(departmentsname.getText().toString()).child(semesterName.getText().toString()).child(groupName.getText().toString()).child("Class Notice").child(subjectId);
        dataRef.removeValue();
    ...
    private boolean updateData(String id, String subject, String topics, String date) {
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference().child("All University").child(universityName.getText().toString()).child(departmentsname.getText().toString()).child(semesterName.getText().toString()).child(groupName.getText().toString()).child("Class Notice").child(id);
    ...
    public void uploadStored() {
        ...
        if (!TextUtils.isEmpty(name)) {
            ...
            String id = SubjectReff.child("Class Notice").push().getKey();
            Data data = new Data(id, name, topics, time);
            SubjectReff.child("Class Notice").child(id).setValue(data);
