...
public class ClassRoutineActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner = findViewById(R.id.class_routine_spinner);
        topicsText = findViewById(R.id.class_routine_topics);
        timeText = findViewById(R.id.class_routine_date);
        uploadBtn = findViewById(R.id.class_routine_upload_btn);
        listViewData = findViewById(R.id.cr_routine_list_view);
        universityName = findViewById(R.id.class_routine_university);
        departmentsname = findViewById(R.id.class_routine_departments);
        semesterName = findViewById(R.id.class_routine_semester);
        groupName = findViewById(R.id.class_routine_group);


        spinnerDataList = new ArrayList<>();
        adapter = new ArrayAdapter<String>(ClassRoutineActivity.this,
                            ...
                            if (dataSnapshot.exists())
                            {
                                ...
                                mRef.addValueEventListener(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                        ...
                                        DataList adapter = new DataList(ClassRoutineActivity.this, dataList);
    ...
    public void deleteData(String subjectId) {
        DatabaseReference dataRef = FirebaseDatabase.getInstance().getReference().child("All University").child(universityName.getText().toString()).child(departmentsname.getText().toString()).child(semesterName.getText().toString()).child(groupName.getText().toString()).child("Class Routine").child(subjectId);
        dataRef.removeValue();
    ...
    private boolean updateData(String id, String subject, String topics, String date) {
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference().child("All University").child(universityName.getText().toString()).child(departmentsname.getText().toString()).child(semesterName.getText().toString()).child(groupName.getText().toString()).child("Class Routine").child(id);
    ...
    public void uploadStored() {
        ...
        if (!TextUtils.isEmpty(name)) {
            ...
            String id = SubjectReff.child("Class Routine").push().getKey();
            Data data = new Data(id, name, topics, time);
            SubjectReff.child("Class Routine").child(id).setValue(data);
